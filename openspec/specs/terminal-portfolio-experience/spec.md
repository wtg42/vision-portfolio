...
The system SHALL use a dark phosphor-green terminal interface while preserving every portfolio photograph's natural color, contrast, and opacity.

#### Scenario: Portfolio photograph is rendered
- **WHEN** a photograph appears in a card or viewer
- **THEN** terminal scanlines, tinting, glow, blend modes, and noise are not applied to the photograph pixels
...
The system SHALL provide visible keyboard focus, sufficient interface contrast, a skip link, semantic landmarks, and reduced-motion behavior for decorative terminal effects.

#### Scenario: Reduced motion is requested
- **WHEN** the visitor's environment reports `prefers-reduced-motion: reduce`
- **THEN** boot, flicker, cursor, and transition animations are disabled or rendered as static states
